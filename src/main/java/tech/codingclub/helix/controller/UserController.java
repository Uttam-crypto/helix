...
public class UserController extends BaseController {
    ...
    ArrayList<TweetUI> fetchTweet(@PathVariable("id") Long id, HttpServletRequest request, HttpServletResponse response) {
        ...
        List<Member> members=(List<Member>)GenericDB.getRows(tech.codingclub.helix.tables.Member.MEMBER, Member.class,null,null);
    ...
    public String followed(ModelMap modelMap, HttpServletResponse response, HttpServletRequest request) {
        ...
        Long currentMemberId= ControllerUtils.getCurrentMember(request).getId();
        ...
        Condition selectedMemberCondition= tech.codingclub.helix.tables.Member.MEMBER.ID.in(followedIds);
        List<Member> members= (List<Member>)GenericDB.getRows(tech.codingclub.helix.tables.Member.MEMBER,Member.class,selectedMemberCondition,10, tech.codingclub.helix.tables.Member.MEMBER.ID.desc());
